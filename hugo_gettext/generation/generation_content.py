...
from .generation_utils import L10NEnv, L10NResult, gettext_func
    ...
    for cond in i18n_conditions:
        ...
        if item not in l10n_results:
            ...
            if item == 'strings':
                ...
                cond_l10n_env = L10NEnv(l10n_results, l10n_env.hugo_lang_code, l10n_func, l10n_env.mdi, src_strings)
...
def generate_content_domain(domain_paths: List[str], l10n_env: L10NEnv):
    file_l10n_count = 0
    for src_path in domain_paths:
        if os.path.isfile(src_path):
            ...
            if fm_result.l10n_count > 0 or content_result.rate == -1 or content_result.rate > 0.5:
                ...
                write_content_file(fm_result.localized, content_result.localized, src_path, l10n_env.hugo_lang_code)
                file_l10n_count += 1
